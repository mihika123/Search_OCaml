...
TARGETS="dictionary.cmo dictionarySet.cmo listDictionary.cmo treeDictionary.cmo\
  engine.cmo listEngine.cmo treeEngine.cmo authors.cmo"
ZIP=search.zip
ZIPCHECKFILE=listDictionary.ml
