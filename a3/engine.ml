...
functor
  ...
  struct
    ...
    let to_list idx = failwith "Unimplemented"

    let words idx = failwith "Unimplemented"

    let or_not idx ors nots = failwith "Unimplemented"

    let and_not idx ands nots = failwith "Unimplemented"

    let format fmt idx = Format.fprintf fmt "<unimplemented>"
  end
